...
const DownloadCsvForm = () => {
  ...
  const searchIconRef = useRef(null);
      ...
      const fetchLastUpdatedTime = async () => {
        try {
          const response = await axios.get(
            "http://192.168.10.11:8000/lastUpdated"
          ...
          if (response.data.success) {
            ...
            setError("Failed to fetch last updated time.");
          }
        } catch (err) {
    ...
    console.log("Last Updated Time: ", lastUpdated);
  ...
  const handleFocus = (e) => {
    ...
    gsap.to(searchIconRef.current, {
      duration: 0.3,
      x: "-100px", // Move the icon to the left
      ease: "power2.out",
    });
    ...
    gsap.to(e.target, {
      ...
      x: "-140px", // Move the input left by 200px
      textAlign: "center",
      borderRadius: "20px", // Set border-radius to 20px
      borderWidth: "4px", // Set border width to 2px
  ...
  const handleBlur = (e) => {
    ...
    gsap.to(e.target, {
      duration: 0.3,
      width: "100%",
      x: "0", // Shrink width back to normal
    ...
    <div className="pt-8 w-full relative">
      ...
      <div className="flex flex-col justify-center items-center">
        ...
        <p>
          Last updated at:{" "}
          {lastUpdated
            ? new Date(lastUpdated).toLocaleString("en-BD", {
                timeZone: "Asia/Dhaka",
              })
            : "Loading..."}
        </p>

        <div className="flex flex-row justify-between items-center gap-4 bg-red-600">
